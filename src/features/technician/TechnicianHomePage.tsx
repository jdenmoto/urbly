          ...
          <div className="rounded-3xl border border-emerald-100 bg-white p-5 shadow-sm ring-1 ring-emerald-50">
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              <span className="inline-flex items-center rounded-full bg-sky-50 px-3 py-1 text-xs font-semibold text-sky-700">
                {t('technician.actions.recommended')}
              </span>
              <Link
                ...
                aria-label={t('technician.actions.openService')}
              >
                {t('technician.actions.openService')}
              </Link>
              <Link
                className={closeoutActionClass}
                to={`/services/${primaryOrder.id}/closeout`}
                state={technicianListState}
                aria-label={t('technician.actions.closeOrReport')}
              >
                ...
                <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                  ...
                  <div className="flex flex-wrap gap-3">
                    <Link
                      ...
                      aria-label={t('technician.actions.detail')}
                    >
                      {t('technician.actions.detail')}
                    </Link>
                    <Link
                      className={`${closeoutActionClass} border border-amber-200 bg-amber-50 text-amber-700 hover:bg-amber-100 focus-visible:ring-amber-200`}
                      to={`/services/${order.id}/closeout`}
                      state={technicianListState}
                      aria-label={t('technician.actions.progressCloseout')}
                    >
